...
## Run compiler
- `ifcccompile.sh filename` compiles a program
- `ifccexec.sh filename` compiles and runs a program
- `ifcc filename` compiles a program (without assemble and link)
- `assemble-and-link.sh` assembles and links a program generated by the command above
